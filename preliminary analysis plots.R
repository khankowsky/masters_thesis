...
#Zooming in on the GOM and looking at tow length 
paired_tows_5mi_72hr %>%
  ggplot() + 
  geom_sf(data = areas, fill = "grey") +
  geom_polygon(data = NEUS, aes(x=long, y = lat, group = group), fill = "darkgreen",  
...
#Zooming in on the GB and looking at tow length 
paired_tows_5mi_72hr %>%
  ggplot() + 
  geom_sf(data = areas, fill = "grey") +
  geom_polygon(data = NEUS, aes(x=long, y = lat, group = group), fill = "darkgreen",  
...
#Zooming in on the SNE and looking at tow length 
paired_tows_5mi_72hr %>%
  ggplot() + 
  geom_sf(data = areas, fill = "grey") +
  geom_polygon(data = NEUS, aes(x=long, y = lat, group = group), fill = "darkgreen",  
