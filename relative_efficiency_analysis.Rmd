...
## Paired T Tests
```{r}
cod_ttest <- t.test(cod_paired_tows_5mi_72hr_re$sf_species_cpua, cod_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
cod_ttest


haddock_ttest <- t.test(haddock_paired_tows_5mi_72hr_re$sf_species_cpua, haddock_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
haddock_ttest


witchfl_ttest <- t.test(witchfl_paired_tows_5mi_72hr_re$sf_species_cpua, witchfl_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
witchfl_ttest


yellowtail_ttest <- t.test(yellowtailfl_paired_tows_5mi_72hr_re$sf_species_cpua, yellowtailfl_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
yellowtail_ttest


plaice_ttest <- t.test(plaice_paired_tows_5mi_72hr_re$sf_species_cpua, plaice_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
plaice_ttest


winterfl_ttest <- t.test(winterfl_paired_tows_5mi_72hr_re$sf_species_cpua, winterfl_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
winterfl_ttest


monkfish_ttest <- t.test(monkfish_paired_tows_5mi_72hr_re$sf_species_cpua, monkfish_paired_tows_5mi_72hr_re$nefsc_species_cpua, paired = TRUE)
monkfish_ttest
```
