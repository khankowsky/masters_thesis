...
dt <-  #distance towed
w0 <- (1223.7+(0.8*(70.8+(1.8*VesselTonnage)+(0.5*VesselHP)))*sin(40)) #effective width of otter board
c0 <- 1.00  #contact index of otter board
wc <- ((23.3 + (0.4*vessellength)*0.001*2)*sin(15)) #effective width of ground cable (km)
cc <- 0.95 #contact index of ground cables 
ws <-  #effective width of sweep 
cs <- 0.90 #contact index of sweep
...
sf_trawl_slim <- sf_trawl_slim %>%
  mutate(swept_area = dt[(2*w0*c0) + (2*wc*cc) + (ws*cs)])
