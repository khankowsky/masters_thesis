...
haddock_ttest <- t.test(haddock_paired_tows_5mi_72hr_re$log_sf_species_cpua, 
                        haddock_paired_tows_5mi_72hr_re$log_nefsc_species_cpua, 
                        paired = TRUE)
haddock_ttest
...
witchfl_ttest <- t.test(witchfl_paired_tows_5mi_72hr_re$log_sf_species_cpua, 
                        witchfl_paired_tows_5mi_72hr_re$log_nefsc_species_cpua, 
                        paired = TRUE, var.equal = FALSE)
witchfl_ttest


witchfl_wsrt <- wsrTest(witchfl_paired_tows_5mi_72hr_re$sf_species_cpua,
                            witchfl_paired_tows_5mi_72hr_re$nefsc_species_cpua)
witchfl_wsrt
