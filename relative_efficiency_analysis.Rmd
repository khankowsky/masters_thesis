...
#storing the optimal model and plotting the diagnostics
haddockm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + towTime,
...
haddock_paired_tows_5mi_72hr_re %>%
  ...
  labs(x = "Vessel Name", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = 0.7354697, linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  coord_flip()
...
#storing the optimal model and plotting the diagnostics
witchflm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + AVGDEPTH, 
...
witchfl_paired_tows_5mi_72hr_re %>%
  ...
  labs(x = "Vessel Name", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = 0.2454456, linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  coord_flip()
...
#storing the optimal model and plotting the diagnostics
plaicem_optimal <- glm(relative_efficiency ~ VESSEL_NAME + season, 
...
plaice_paired_tows_5mi_72hr_re %>%
  ...
  labs(x = "Vessel Name", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = 0.5014979, linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  coord_flip()
...
#storing the optimal model and plotting the diagnostics
winterflm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + AVGDEPTH, 
...
winterfl_paired_tows_5mi_72hr_re %>%
  ...
  labs(x = "Vessel Name", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = 0.4143611, linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  coord_flip()
...
#storing the optimal model and plotting the diagnostics
monkfishm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + AVGDEPTH, 
...
monkfish_paired_tows_5mi_72hr_re %>%
  ...
  labs(x = "Vessel Name", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = 0.3425527, linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  coord_flip()
