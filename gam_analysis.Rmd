...
## Witch Flounder 
```{r}
witchfl_gam <- mgcv::gam(CATCH ~ te(midpoint_lat, midpoint_long, days_from) + factor(trawl_type1) + log(swept_area), 
...
## Yellowtail Flounder 
```{r}
yellowtailfl_gam <- mgcv::gam(CATCH ~ te(midpoint_lat, midpoint_long, days_from) + factor(trawl_type1) + log(swept_area), 
