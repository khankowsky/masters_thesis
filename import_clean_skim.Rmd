...
vw <- vw %>%
  ...
  mutate_at(c("TowStartLat", "TowEndLat", "TowStartLong", "TowEndLong"), str_replace, "\\.", "")
...
vw_slim <- vw %>% 
  select("TowID", "VesselID", "GearID", "Start_Tow_Date", "TowStartLat", 
         "TowStartLong", "TowStartDepth", "END_TOW_DATE", "TowEndLat", 
         "TowEndLong", "TowEndLong", "TowEndDepth", "SpeciesID", 
         "common_name", "TotalWeight_kg") %>%
