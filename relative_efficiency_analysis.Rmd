...
fit.models <- function(x) {
  formulae$formula %>% purrr::map( ~glm(.x, data=x))
}
...
## Paired T Tests
```{r}
cod_ttest <- t.test(cod_paired_tows_5mi_72hr_logre$sf_species_cpua, cod_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
cod_ttest


haddock_ttest <- t.test(haddock_paired_tows_5mi_72hr_logre$sf_species_cpua, haddock_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
haddock_ttest


witchfl_ttest <- t.test(witchfl_paired_tows_5mi_72hr_logre$sf_species_cpua, witchfl_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
witchfl_ttest


yellowtail_ttest <- t.test(yellowtailfl_paired_tows_5mi_72hr_logre$sf_species_cpua, yellowtailfl_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
yellowtail_ttest


plaice_ttest <- t.test(plaice_paired_tows_5mi_72hr_logre$sf_species_cpua, plaice_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
plaice_ttest


winterfl_ttest <- t.test(winterfl_paired_tows_5mi_72hr_logre$sf_species_cpua, winterfl_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
winterfl_ttest


monkfish_ttest <- t.test(monkfish_paired_tows_5mi_72hr_logre$sf_species_cpua, monkfish_paired_tows_5mi_72hr_logre$nefsc_species_cpua, paired = TRUE)
monkfish_ttest
```
...
```{r}
#COD
codm <- fit.models(cod_paired_tows_5mi_72hr_logre)
...
```{r}
#HADDOCK
haddockm <- fit.models(haddock_paired_tows_5mi_72hr_logre)
...
```{r}
#WITCH FLOUNDER 
witchflm <- fit.models(witchfl_paired_tows_5mi_72hr_logre)
...
```{r}
#YELLOWTAIL FLOUNDER
yellowtailflm <- fit.models(yellowtailfl_paired_tows_5mi_72hr_logre)
...
```{r}
#AMERICAN PLAICE 
plaicem <- fit.models(plaice_paired_tows_5mi_72hr_logre)
...
```{r}
#WINTER FLOUNDER 
winterflm <- fit.models(winterfl_paired_tows_5mi_72hr_logre)
...
```{r}
#MONKFISH 
monkfishm <- fit.models(monkfish_paired_tows_5mi_72hr_logre)
