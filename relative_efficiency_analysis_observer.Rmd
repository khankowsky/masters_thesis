...
# Read-In the Data
```{r}
paired_tows_1mi_24hr_ob <- read.csv('./data/ob_paired_data/paired_tows_1mi_24hr_ob.csv')
paired_tows_5mi_72hr_ob <- read.csv('./data/ob_paired_data/paired_tows_5mi_72hr_ob.csv')
```
...
fit.models <- function(x) {
  formulae$formula %>% purrr::map( ~glm(.x, family = binomial(link='logit'), data=x))
}
...
#footrope type - as.factor(FTROPTYP)
p7 <- x %>%
  ggplot(aes(x = trawl_type, 
             y = fitted, 
             col = as.factor(FTROPTYP))) + 
  geom_jitter(width=0.2) + 
  stat_summary(
    geom = "point",
    fun = "mean",
  ...
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  scale_color_discrete(labels=c("0" = "Unknown", 
                                "1" = "Chain",
                                "2" = "Cable/Wire", 
                                "3" = "Wrapped Cable", 
                                "4" = "Rock Hopper", 
...
#ground cable type - as.factor(GRCABTYP)
p8 <- x %>%
  ggplot(aes(x = trawl_type, 
             y = fitted, 
             col = as.factor(GRCABTYP))) + 
  geom_jitter(width=0.2) + 
  stat_summary(
    geom = "point",
    fun = "mean",
...
#bridle/leg type - as.factor(BRDLGTYP)
p9 <- x %>%
  ggplot(aes(x = trawl_type, 
             y = fitted, 
             col = as.factor(BRDLGTYP))) + 
  geom_jitter(width=0.2) + 
  stat_summary(
    geom = "point",
    fun = "mean",
...
grid.arrange(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10, ncol = 2, top = "Main")
...
```{r}
paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob %>%
  ...
  mutate(relative_efficiency = nefsc_species_cpua_LB/(nefsc_species_cpua_LB + ob_species_cpua)) %>%
...
#COD
cod_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
  filter(SVSPP == 73 & NESPP4 == 818) %>% 
  distinct(trip_haul_ID, .keep_all = TRUE)

#HADDOCK
haddock_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
  filter(SVSPP == 74 & NESPP4 == 1477) %>% 
  distinct(trip_haul_ID, .keep_all = TRUE)

#WITCH FLOUNDER
witchfl_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
  filter(SVSPP == 107 & NESPP4 == 1220) %>% 
  distinct(trip_haul_ID, .keep_all = TRUE)

#YELLLOWTAIL FLOUNDER
yellowtailfl_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
  filter(SVSPP == 105 & NESPP4 == 1230) %>% 
  distinct(trip_haul_ID, .keep_all = TRUE)

#AMERICAN PLAICE
plaice_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
  filter(SVSPP == 102 & NESPP4 == 1240) %>%
  distinct(trip_haul_ID, .keep_all = TRUE)

#WINTER FLOUNDER
winterfl_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
  filter(SVSPP == 106 & NESPP4 == 1200) %>%
  distinct(trip_haul_ID, .keep_all = TRUE)

#MONKFISH
monkfish_paired_tows_1mi_24hr_ob_re <- paired_tows_1mi_24hr_ob_re %>%
...
```{r}
#COD
cod_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
...
#HADDOCK
haddock_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity") + 
  labs(x = "Tow Number", y = CPUA_label, 
...
#WITCH FLOUNDER
witchfl_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity") + 
  labs(x = "Tow Number", y = CPUA_label, 
...
#YELLLOWTAIL FLOUNDER
yellowtailfl_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity") + 
  labs(x = "Tow Number", y = CPUA_label, 
...
#AMERICAN PLAICE
plaice_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity") + 
  labs(x = "Tow Number", y = CPUA_label, 
...
#WINTER FLOUNDER
winterfl_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity") + 
  labs(x = "Tow Number", y = CPUA_label, 
...
#MONKFISH - NO MONKFISH MATCHES AT 1&1
# monkfish_paired_tows_1mi_24hr_ob_re %>%
#   ggplot() + 
#   geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity") + 
#   geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity") + 
#   labs(x = "Tow Number", y = CPUA_label, 
...
#COD
p1 <- cod_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
...
#HADDOCK
p2 <- haddock_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity", fill = "red") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity", fill = "blue") + 
  labs(x = "", y = "", 
...
#WITCH FLOUNDER
p3 <- witchfl_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity", fill = "red") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity", fill = "blue") + 
  labs(x = "", y = "", 
...
#YELLLOWTAIL FLOUNDER
p4 <- yellowtailfl_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity", fill = "red") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity", fill = "blue") + 
  labs(x = "", y = "", 
...
#AMERICAN PLAICE
p5 <- plaice_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity", fill = "red") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity", fill = "blue") + 
  labs(x = "", y = "", 
...
#WINTER FLOUNDER
p6 <- winterfl_paired_tows_1mi_24hr_ob_re %>%
  ggplot() + 
  geom_bar(aes(x = trip_haul_ID, y = ob_species_cpua, fill = "Observer"), stat = "identity", fill = "red") + 
  geom_bar(aes(x = trip_haul_ID, y = -nefsc_species_cpua_LB, fill = "NEFSC"), stat = "identity", fill = "blue") + 
  labs(x = "", y = "", 
...
grid.arrange(p1, p2, p3 ,p4 ,p5, p6, 
             top = "Comparison of CPUA for 1 Mile & 1 Day Matches - Observer", 
...
cod_paired_tows_5mi_72hr_ob_re <- cod_paired_tows_5mi_72hr_ob_re %>%
  mutate(diff = ob_species_cpua - nefsc_species_cpua_LB,
         log_ob_species_cpua = log(ob_species_cpua), 
         log_nefsc_species_cpua_LB = log(nefsc_species_cpua_LB), 
         diff_of_logs = log_ob_species_cpua - log_nefsc_species_cpua_LB)
...
cod_ob_ttest <- t.test(cod_paired_tows_5mi_72hr_ob_re$log_ob_species_cpua, cod_paired_tows_5mi_72hr_ob_re$log_nefsc_species_cpua_LB, paired = TRUE)
cod_ob_ttest
...
codm_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
                    family = binomial, data = cod_paired_tows_5mi_72hr_ob_re)

codm_ob_optimal <- glm(relative_efficiency ~ trawl_type + AVGDEPTH + BOTTEMP + DayNight, family = binomial, data = cod_paired_tows_5mi_72hr_ob_re)

par(mfrow=c(2,2))
plot(codm_ob_optimal)

summary(codm_ob_full)
...
cod_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(cod_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
...
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(cod_paired_tows_5mi_72hr_ob_re)
```
...
haddock_ob_ttest <- t.test(haddock_paired_tows_5mi_72hr_ob_re$log_ob_species_cpua, haddock_paired_tows_5mi_72hr_ob_re$log_nefsc_species_cpua_LB, paired = TRUE)
haddock_ob_ttest
...
#storing the optimal model and plotting the diagnostics
haddockm_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
...
haddock_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(haddock_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  coord_flip()
...
```{r, fig.width=15, fig.height=15}
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(haddock_paired_tows_5mi_72hr_ob_re)
```
...
witchfl_ob_ttest <- t.test(witchfl_paired_tows_5mi_72hr_ob_re$log_ob_species_cpua, witchfl_paired_tows_5mi_72hr_ob_re$log_nefsc_species_cpua_LB, paired = TRUE)
witchfl_ob_ttest
...
#storing the optimal model and plotting the diagnostics
witchflm_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
                    family = binomial, data = witchfl_paired_tows_5mi_72hr_ob_re)

witchflm_ob_optimal <- glm(relative_efficiency ~ trawl_type + AVGDEPTH + towTime, 
                           family = binomial, data = witchfl_paired_tows_5mi_72hr_ob_re)

par(mfrow=c(2,2))
plot(witchflm_ob_optimal)

summary(witchflm_ob_full)
...
witchfl_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(witchfl_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  coord_flip()
...
```{r, fig.width=15, fig.height=15}
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(witchfl_paired_tows_5mi_72hr_ob_re)
```
...
yellowtail_ob_ttest <- t.test(yellowtailfl_paired_tows_5mi_72hr_ob_re$log_ob_species_cpua,
                              yellowtailfl_paired_tows_5mi_72hr_ob_re$log_nefsc_species_cpua_LB, 
                              paired = TRUE)
yellowtail_ob_ttest
...
#storing the optimal model and plotting the diagnostics
yellowtailflm_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
                    family = binomial, data = yellowtailfl_paired_tows_5mi_72hr_ob_re)

yellowtailflm_ob_optimal <- glm(relative_efficiency ~ trawl_type + season + towTime, 
                                family = binomial, data = yellowtailfl_paired_tows_5mi_72hr_ob_re)

par(mfrow=c(2,2))
plot(yellowtailflm_ob_optimal)

summary(yellowtailflm_ob_full)
...
yellowtailfl_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(yellowtailfl_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  coord_flip()
...
```{r, fig.width=15, fig.height=15}
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(yellowtailfl_paired_tows_5mi_72hr_ob_re)
```
...
plaice_ob_ttest <- t.test(plaice_paired_tows_5mi_72hr_ob_re$log_ob_species_cpua, 
                       plaice_paired_tows_5mi_72hr_ob_re$log_nefsc_species_cpua_LB, 
                       paired = TRUE)
plaice_ob_ttest
...
#storing the optimal model and plotting the diagnostics
plaicem_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
...
plaice_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(plaice_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  coord_flip()
...
```{r, fig.width=15, fig.height=15}
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(plaice_paired_tows_5mi_72hr_ob_re)
```
...
winterfl_ob_ttest <- t.test(winterfl_paired_tows_5mi_72hr_ob_re$ob_species_cpua, 
                            winterfl_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, 
                            paired = TRUE)
winterfl_ob_ttest
...
#storing the optimal model and plotting the diagnostics
winterflm_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
...
winterfl_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(winterfl_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  coord_flip()
...
```{r, fig.width=15, fig.height=15}
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(winterfl_paired_tows_5mi_72hr_ob_re)
```
...
monkfish_ob_ttest <- t.test(monkfish_paired_tows_5mi_72hr_ob_re$log_ob_species_cpua, 
                         monkfish_paired_tows_5mi_72hr_ob_re$log_nefsc_species_cpua_LB, 
                         paired = TRUE)
monkfish_ob_ttest
...
#storing the optimal model and plotting the diagnostics
monkfishm_ob_full <- glm(relative_efficiency ~ trawl_type + season + mgmt_area + AVGDEPTH + BOTTEMP + DayNight + towTime, 
                            family = binomial, data = monkfish_paired_tows_5mi_72hr_ob_re)

monkfishm_ob_optimal <- glm(relative_efficiency ~ trawl_type + season + mgmt_area, 
                            family = binomial, data = monkfish_paired_tows_5mi_72hr_ob_re)

par(mfrow=c(2,2))
plot(monkfishm_ob_optimal)

summary(monkfishm_ob_full)
...
monkfish_paired_tows_5mi_72hr_ob_re %>%
  ...
  labs(x = "Trawl Type", y = "Fitted Values of Relative Efficiency") + 
  geom_hline(yintercept = mean(monkfish_paired_tows_5mi_72hr_ob_re$fitted), linetype = "dashed", color = "red") + 
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "black") + 
  scale_x_discrete(labels=c("1" = "Groundfish Trawls", "2" = "Flatfish Trawls",
                              "3" = "Separator Trawls", "4" = "Eliminator Trawls")) + 
  coord_flip()
...
```{r, fig.width=15, fig.height=15}
#plotting the relative efficency by trawl type and other explanatory variables 
re_plots(monkfish_paired_tows_5mi_72hr_ob_re)
```

# Correlation Tests
```{r}
#COD
cort_cod <- cor.test(cod_paired_tows_5mi_72hr_ob_re$ob_species_cpua, cod_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
#HADDOCK
cort_haddock <- cor.test(haddock_paired_tows_5mi_72hr_ob_re$ob_species_cpua, haddock_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
#WITCH FLOUNDER
cort_witchfl <- cor.test(witchfl_paired_tows_5mi_72hr_ob_re$ob_species_cpua, witchfl_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
#YELLOWTAIL FLOUDNER
cort_yellowtailfl <- cor.test(yellowtailfl_paired_tows_5mi_72hr_ob_re$ob_species_cpua, yellowtailfl_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
#AMERICAN PLAICE 
cort_plaice <- cor.test(plaice_paired_tows_5mi_72hr_ob_re$ob_species_cpua, plaice_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
#WINTER FLOUNDER 
cort_winterfl <- cor.test(winterfl_paired_tows_5mi_72hr_ob_re$ob_species_cpua, winterfl_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
#MONKFISH 
cort_monkfish <- cor.test(monkfish_paired_tows_5mi_72hr_ob_re$ob_species_cpua, monkfish_paired_tows_5mi_72hr_ob_re$nefsc_species_cpua_LB, method = "pearson")
...
# plotting relative efficiency with expanatory variables 
```{r}
###############################################################################
# #predicted vs trawl type w point shape as explanatory variables - not important for this project but saving for my thesis work 
...
#codend mesh type - CODHUNG
p11 <- x %>%
  ggplot(aes(x = trawl_type, 
             y = fitted, 
             col = as.factor(CODHUNG))) + 
  geom_jitter(width=0.2) + 
  stat_summary(
    geom = "point",
    fun = "mean",
...
grid.arrange(p1,p2, ncol =2, top = x$COMNAME)
grid.arrange(p3,p4, ncol =2, top = x$COMNAME)
grid.arrange(p5,p6, ncol =2, top = x$COMNAME)
grid.arrange(p7,p8, ncol =2, top = x$COMNAME)
grid.arrange(p9,p10, ncol =2, top = x$COMNAME)
grid.arrange(p11, top = x$COMNAME)
...
haddock_paired_tows_5mi_72hr_ob_re %>%
  select(trawl_type, relative_efficiency, nefsc_species_cpua_LB, ob_species_cpua)
