...
## GLM for relative efficiency
```{r}
glm.null <- glm(relative_efficiency ~ 1. data = paired_tows_5mi_72hr_logre, family = )
glm.seas <- glm(relative_efficiency ~ season, data = paired_tows_5mi_72hr_logre)
glm.mgmt <- glm(relative_efficiency ~ mgmt_area, data = paired_tows_5mi_72hr_logre)
glm.seas.mgmt <- glm(relative_efficiency ~ season + mgmt_area, data = paired_tows_5mi_72hr_logre)
