...
witchflm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + mgmt_area, 
                        family = binomial, data = witchfl_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
yellowtailflm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + season + mgmt_area + AVGDEPTH, 
                             family = binomial, data = yellowtailfl_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
winterflm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + mgmt_area + AVGDEPTH, 
                         family = binomial, data = winterfl_paired_tows_5mi_72hr_re)
