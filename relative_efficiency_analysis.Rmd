...
ggpairs(cod_paired_tows_5mi_72hr_re, 
        columns = c("relative_efficiency", "season", "mgmt_area", "VESSEL_NAME", "AVGDEPTH", "SURFTEMP", "BOTTEMP"), 
...
covars <- c("season", "mgmt_area", "VESSEL_NAME", "AVGDEPTH", "SURFTEMP", "BOTTEMP")
...
codm_optimal <- glm(relative_efficiency ~ season + SURFTEMP, family = binomial, data = cod_paired_tows_5mi_72hr_re)
...
#looking at the boxplot and histograms of the log(catch per unit area)
box.log.plot(haddock_paired_tows_5mi_72hr_re)
hist_log_kh(haddock_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
haddockm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + SURFTEMP, family = binomial, data = haddock_paired_tows_5mi_72hr_re)
...
#looking at the boxplot and histograms of the log(catch per unit area)
box.log.plot(witchfl_paired_tows_5mi_72hr_re)
hist_log_kh(witchfl_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
witchflm_optimal <- glm(relative_efficiency ~ mgmt_area + SURFTEMP, family = binomial, data = witchfl_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
yellowtailflm_optimal <- glm(relative_efficiency ~ mgmt_area + AVGDEPTH + SURFTEMP + BOTTEMP, family = binomial, data = yellowtailfl_paired_tows_5mi_72hr_re)
...
#looking at the boxplot and histograms of the log(catch per unit area)
box.log.plot(plaice_paired_tows_5mi_72hr_re)
hist_log_kh(plaice_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
plaicem_optimal <- glm(relative_efficiency ~ season + SURFTEMP, family = binomial, data = plaice_paired_tows_5mi_72hr_re)
...
#looking at the boxplot and histograms of the log(catch per unit area)
box.log.plot(winterfl_paired_tows_5mi_72hr_re)
hist_log_kh(winterfl_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
winterflm_optimal <- glm(relative_efficiency ~ mgmt_area + AVGDEPTH + SURFTEMP + BOTTEMP, family = binomial, data = winterfl_paired_tows_5mi_72hr_re)
...
#looking at the boxplot and histograms of the log(catch per unit area)
box.log.plot(monkfish_paired_tows_5mi_72hr_re)
hist_log_kh(monkfish_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
monkfishm_optimal <- glm(relative_efficiency ~ AVGDEPTH + SURFTEMP + BOTTEMP, family = binomial, data = monkfish_paired_tows_5mi_72hr_re)
