...
```{r}
#calculating the catch per swept area (this keeps the kept and discarded separate)
# sf_trawl <- sf_trawl %>% 
#   # filter(DISPOSITION_CODE == 011) %>% #this uses just the kept catch
#   mutate(CATCH_per_SWEPT_AREA = HAIL_AMOUNT_LB/swept_area)

#calculates the catch per swept area with the discard and kept catch combined
sf_trawl <- sf_trawl %>% 
