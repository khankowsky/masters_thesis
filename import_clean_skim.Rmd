...
observer_trawl <- observer_trawl %>%
  mutate(dayNight = ifelse(START_TOW_DATE > sunrise & START_TOW_DATE < sunset, 'day', 'night'))
...
sf_trawl <- sf_trawl %>% 
  mutate(dayNight = ifelse(START_TOW_DATE_EST > sunrise & START_TOW_DATE_EST < sunset, 'day', 'night'))
...
nefsc_slim <- nefsc %>%
  select(c("cruise_station_ID", "STRATUM", "AREA", "SVVESSEL", "SVGEAR", 
           ...
           "SWEPT_AREA", "nefsc_species_cpua", "dayNight_nesfc"))
